...
- Syncs carry daily aggregates plus a Receipt Stream: hashes of per-message identifiers (Claude Code `message.id:requestId`, Codex equivalents), never content. The server dedupes across Devices and checks stream coherence.
