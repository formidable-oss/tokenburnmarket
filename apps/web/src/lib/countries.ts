/*
  ISO 3166-1 alpha-2 countries, the full list, English names, sorted by name.
  A Builder Region is one of these codes; the continent is derived elsewhere.
  Generated from ICU region display names. Keep codes uppercase alpha-2.
*/
...
/** Returns the country for an ISO alpha-2 code, or undefined if the code is unknown. */
...
/** True when the value is an ISO 3166-1 alpha-2 code we accept. */
